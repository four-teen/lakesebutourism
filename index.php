                ...
                <div class="highlight-toolbar">
                    ...
                    <div>
                        ...
                        <div class="highlight-results mt-2">
                            ...
                            <span id="highlightResultsValue">4 featured stops shown</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 highlight-card"
                    ...
                    <article class="highlight-surface">
                        ...
                        <div class="highlight-content">
                            ...
                            <div class="highlight-metrics">
                                <span class="highlight-metric"><i class="bx bx-group"></i> Family-friendly</span>
        ...
        <div class="section-shell section-shell-soft">
            <div class="tour-toolbar mb-4">
                <div class="section-copy">
                    ...
                    <p class="section-sub mb-0">These are guide prices for common visitor activities. Use the assistant for quick questions, then confirm with accredited operators.</p>
                </div>
            ...
            <div class="table-card table-responsive">
                <table class="table table-hover align-middle tour-table">
                    ...
                    <tr>
                        ...
                        <th>Category</th>
                        <th class="text-center">Ask Assistant</th>
                    </tr>
                    </thead>
                    <tbody id="tourRows">
                    <tr data-cat="adventure">
                        ...
                        <td class="text-center"><button class="btn btn-sm btn-primary inquire-tour" data-tour="Seven Falls Zipline"><i class="bx bx-message-square-dots me-1"></i>Ask Assistant</button></td>
                    </tr>
                    <tr data-cat="water">
                        ...
                        <td class="text-center"><button class="btn btn-sm btn-primary inquire-tour" data-tour="Lotus Sunrise Cruise"><i class="bx bx-message-square-dots me-1"></i>Ask Assistant</button></td>
                    </tr>
                    <tr data-cat="culture">
                        ...
                        <td class="text-center"><button class="btn btn-sm btn-primary inquire-tour" data-tour="T'boli Weaving and Culture"><i class="bx bx-message-square-dots me-1"></i>Ask Assistant</button></td>
                    </tr>
                    <tr data-cat="family">
                        ...
                        <td class="text-center"><button class="btn btn-sm btn-primary inquire-tour" data-tour="Waterfall Trek"><i class="bx bx-message-square-dots me-1"></i>Ask Assistant</button></td>
                    </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="section-shell">
            ...
            <div class="establishment-toolbar">
                <div class="establishment-count">
                    <strong id="establishmentResultsValue"><?php echo count($tourismEstablishments); ?> establishments shown</strong>
                ...
                <div class="establishment-controls">
                    ...
                    <input id="establishmentSearch" class="form-control" type="search" placeholder="Search establishments" aria-label="Search establishments">
                </div>
            </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card stay-card h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="small text-muted mb-3">Best for local coffee, rice cakes, and a softer start before heading to the lake.</p>
    ...
    <section id="plan" class="container py-5">
        <div class="section-shell">
            ...
            <div class="row g-4 mt-1 plan-grid">
                <div class="col-md-6 col-lg-4">
                    <div class="planner-map-card">
                        <div id="mapDirectionsTitle" class="fw-semibold mb-3"><i class="bx bx-map-pin me-1"></i> Map and Directions</div>
                ...
                <div class="col-md-6 col-lg-8">
                    <div class="planner-form-card">
                        <div id="tripPlannerTitle" class="fw-semibold mb-3"><i class="bx bxs-edit-alt me-1"></i> Itinerary Planner</div>
                        <form id="tripForm" class="row g-3">
                            ...
                            <div class="col-12">
                                <label id="activitiesLabel" for="activities" class="form-label">Activities and Highlights</label>
                            ...
                            <div class="col-12">
                                <label id="notesLabel" for="notes" class="form-label">Trip Notes</label>
                            ...
                            <div class="col-12">
                                <div class="planner-actions">
                                    ...
                                    <button id="clearPlanBtn" type="reset" class="btn btn-outline-secondary">Clear Plan</button>
                                </div>
...
const plannerCopy = {
    en: {
        ...
        mapDirectionsTitle: 'Map and Directions',
        tripPlannerTitle: 'Itinerary Planner',
        tripNameLabel: 'Trip Name',
        travelDatesLabel: 'Travel Dates',
        activitiesLabel: 'Activities and Highlights',
        notesLabel: 'Trip Notes',
        savePlanLabel: 'Save on This Device',
        clearPlanLabel: 'Clear Plan',
    ...
    fil: {
        ...
        tripPlannerTitle: 'Planner ng Biyahe',
        tripNameLabel: 'Pangalan ng Biyahe',
        travelDatesLabel: 'Mga Petsa ng Biyahe',
        activitiesLabel: 'Mga Aktibidad at Tampok',
        notesLabel: 'Tala ng Biyahe',
        savePlanLabel: 'I-save sa Device na Ito',
        clearPlanLabel: 'I-clear ang Plano',
        ...
        planCleared: 'Nabura ang naka-save na trip plan sa device na ito.'
    }
};
...
$(function() {
    ...
    function updateHighlightResults() {
        ...
        const summary = visibleCount === 1
            ? '1 featured stop shown'
            : `${visibleCount} featured stops shown`;
    ...
    function updateEstablishmentResults() {
        ...
        const summary = visibleCount === 1
            ? '1 establishment shown'
            : `${visibleCount} establishments shown`;
  ...
  (() => {
    ...
    async function readProxyResponse(response) {
      try {
        ...
        return {
          reply: 'The Lake Sebu Assistant could not read the response. Please try again.',
    ...
    chatFormEl.addEventListener('submit', async (e) => {
      ...
      typing.textContent = 'Lake Sebu Assistant is preparing a reply...';
      ...
      try {
        ...
        if (!response.ok) {
          console.error('Chat service returned an error:', {
            status: response.status,
            providerStatus: data.providerStatus || null,
            detail: data.detail || null
          });
          throw new Error(data.reply || 'The Lake Sebu Assistant is temporarily unavailable. Please try again shortly.');
        }
        const reply = data.reply || "Sorry, I could not prepare a reply right now.";
